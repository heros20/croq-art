...
function wpdocs_codex_slider_init() {
    $labels = array(
        ...
        'not_found'             => __( 'Aucunes images trouvées.', 'blank_1' ),
        'not_found_in_trash'    => __( 'Aucune image trouvée dans la corbeille.', 'blank_1' ),
        'featured_image'        => _x( 'Image de couverture du diaporama', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'blank_1' ),
