...
function wpdocs_codex_menu_init() {
    $labels = array(
        ...
        'add_new_item'          => __('Ajouter une nouvelle menu', 'blank_1' ),
        'new_item'              => __('Nouvelle menu', 'blank_1' ),
        'edit_item'             => __( 'Modifier une menu', 'blank_1' ),
        'view_item'             => __( 'Voir la menu', 'blank_1' ),
        'all_items'             => __( 'Toutes les menus', 'blank_1' ),
        'search_items'          => __( 'Rechercher des menus', 'blank_1' ),
        'parent_item_colon'     => __( 'Parent des menus:', 'blank_1' ),
        'not_found'             => __( 'Aucune menus trouvé.', 'blank_1' ),
        'not_found_in_trash'    => __( 'Aucune menu trouvée dans la corbeille.', 'blank_1' ),
        ...
        'items_list_navigation' => _x( 'Navigation dans la liste menus ', 'Screen reader text for the pagination heading on the post type listing screen. Default “Posts list navigation”/”Pages list navigation”. Added in 4.4', 'blank_1' ),
        'items_list'            => _x( 'Liste menus ', 'Screen reader text for the items list heading on the post type listing screen. Default “Posts list”/”Pages list”. Added in 4.4', 'blank_1' ),
    );
